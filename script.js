var map = L.map('mapid').setView([38.626835,-90.21239], 18);
...
var theGrove=L.marker([38.627400228141404,-90.25434454458241]).addTo(map).bindPopup('Sultan Mediterranean Restaurant');
